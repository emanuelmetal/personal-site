...
severity: minor
resolution: Plan 04-02 Task 1 - enabled disableTransitionOnChange in ThemeProvider
...
severity: major
resolution: Plan 04-02 Task 2 - included hash fragment in router.push destination
...
- truth: "EN bold on /en/ route, ES bold on /es/ route. Inactive button changes color on hover."
  ...
  resolution_plan: "04-02"
  resolution_commit: "e1c13b8"
  artifacts:
